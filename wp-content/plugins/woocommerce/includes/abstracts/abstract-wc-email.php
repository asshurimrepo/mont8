<?php
	...
	abstract class WC_Email extends WC_Settings_API {
		...
		{
			return sanitize_email( apply_filters( 'woocommerce_email_from_address', get_option( 'woocommerce_email_from_address' ) ) );
		}
							...
							{ ?>
								...
								<p>
									...
									<?php if ( is_writable( $local_file ) ) : ?>
										<a href="<?php echo esc_url( remove_query_arg( array(
											'move_template',
											'saved'
										), add_query_arg( 'delete_template', $template ) ) ); ?>"
								...
								<div class="editor" style="display:none">
									<textarea class="code" cols="25" rows="20"
									          ...
									          disabled="disabled"
									          <?php else : ?>data-name="<?php echo $template . '_code'; ?>"<?php endif; ?>><?php echo file_get_contents( $local_file ); ?></textarea>
								</div>
								...
								<p>
									...
									{ ?>
										<a href="<?php echo esc_url( remove_query_arg( array(
											'delete_template',
											'saved'
										), add_query_arg( 'move_template', $template ) ) ); ?>"
