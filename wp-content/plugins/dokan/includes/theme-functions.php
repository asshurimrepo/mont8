...
function dokan_post_input_box( $post_id, $meta_key, $attr = array(), $type = 'text'  ) {
    ...
    switch ($type) {
        case 'text':
            $validate = isset( $attr['validate'] ) ? $attr['validate'] : '';
            ?>
            <input type="text" name="<?php echo $name; ?>" id="<?php echo $name; ?>" value="<?php echo esc_attr( $value ); ?>" class="<?php echo $class; ?>" placeholder="<?php echo $placeholder; ?>" <?php echo $validate; ?>>
            <?php
            break;
