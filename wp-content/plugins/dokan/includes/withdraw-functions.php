<?php
	...
	function dokan_withdraw_method_skrill( $store_settings )
	{
		...
		<div class="dokan-form-group">
			<div class="dokan-w8">
				<div class="dokan-input-group">
					<span class="dokan-input-group-addon"><?php _e( 'E-mail', 'dokan' ); ?></span>
					<input value="<?php echo $email; ?>" name="settings[skrill][email]" class="dokan-form-control email"
					       placeholder="you@domain.com" type="text">
				</div>
			</div>
		</div>
	...
	function dokan_withdraw_method_bank( $store_settings )
	{
		...
		<div class="dokan-form-group">
			<div class="doakn-w8">
				<input name="settings[bank][ac_name]" value="<?php echo $account_name; ?>" class="dokan-form-control"
				       placeholder="<?php esc_attr_e( 'Your bank account name', 'dokan' ); ?>" type="text">
			</div>
		</div>

		<div class="dokan-form-group">
			<div class="doakn-w8">
				<input name="settings[bank][ac_number]" value="<?php echo $account_number; ?>"
				       class="dokan-form-control"
				       placeholder="<?php esc_attr_e( 'Your bank account number', 'dokan' ); ?>" type="text">
			</div>
		</div>

		<div class="dokan-form-group">
			<div class="doakn-w8">
				<input name="settings[bank][bank_name]" value="<?php echo $bank_name; ?>" class="dokan-form-control"
				       placeholder="<?php _e( 'Name of bank', 'dokan' ) ?>" type="text">
			</div>
		</div>

		<div class="dokan-form-group">
			<div class="doakn-w8">
				<textarea name="settings[bank][bank_addr]" class="dokan-form-control"
				          placeholder="<?php esc_attr_e( 'Address of your bank', 'dokan' ) ?>"><?php echo $bank_addr; ?></textarea>
			</div>
		</div>

		<div class="dokan-form-group">
			<div class="col-md-10">
				<input value="<?php echo $swift_code; ?>" name="settings[bank][swift]" class="dokan-form-control"
				       placeholder="<?php esc_attr_e( 'Swift code', 'dokan' ); ?>" type="text">
			</div>
		</div> <!-- .dokan-form-group -->
		<?php
	}

	function dokan_withdraw_method_western_union( $store_settings )
	{
		$name    = isset( $store_settings['payment']['western_union']['name'] ) ? esc_attr( $store_settings['payment']['western_union']['name'] ) : '';
		$address = isset( $store_settings['payment']['western_union']['address'] ) ? esc_attr( $store_settings['payment']['western_union']['address'] ) : '';
		?>

		<div class="dokan-form-group">
			<div class="doakn-w8">
				<input name="settings[western_union][name]" value="<?php echo $name; ?>" class="dokan-form-control"
				       placeholder="<?php esc_attr_e( 'Your name', 'dokan' ); ?>" type="text">
			</div>
		</div>

		<div class="dokan-form-group">
			<div class="doakn-w8">
				<input name="settings[western_union][address]" value="<?php echo $address; ?>"
				       class="dokan-form-control"
				       placeholder="<?php esc_attr_e( 'Your address', 'dokan' ); ?>" type="text">
			</div>
		</div>
		<?php
	}
