                    ...
                    <div class="row product-edit-container dokan-clearfix">
                        ...
                        <div class="dokan-w6">
                            <div class="dokan-form-group">
                                <input class="dokan-form-control" name="post_title" id="post-title" type="text" placeholder="<?php esc_attr_e( 'Artwork Name', 'dokan' ); ?>" value="<?php echo dokan_posted_input( 'post_title' ); ?>">
                            </div>
