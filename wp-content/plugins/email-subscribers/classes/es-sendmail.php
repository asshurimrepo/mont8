...
//							wp_mail($to, $subject, $content_send . $unsubtext . $viewstslink, $headers);
								self::wc_send_mail( $to, $subject, $content_send . $unsubtext . $viewstslink );
							}
						}
						else
						{
...
//						wp_mail($adminmail, $adminmailsubject, $adminmailcontant, $headers);
							self::wc_send_mail( $adminmail, $adminmailsubject, $adminmailcontant );
			...
			if ( $type == "newsletter" || $type == "notification" )
			{
				...
				if ( $adminmail <> "" )
				{
					...
					if ( $wpmail )
					{
						self::wc_send_mail( $adminmail, $subject, $reportmail );
					}
					else
					{
