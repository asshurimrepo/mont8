			...
			<div class="feature-wrap about-warning">
					<div class="wc-feature feature-section">
						<div>
							...
							<p><?php _e( 'The WooCommerce Multilingual is NOT supported and will cause loss of data if active when you save your options. There is currently no workaround!', TM_EPO_TRANSLATION ); ?></p>
						</div>
