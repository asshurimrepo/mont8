	...
	public function display_field_pre( $element=array(), $args=array() ) {
		...
		if (!empty($this->items_per_row)){
			...
			if ($this->items_per_row=="auto"){
				...
				$this->css_string=".".$containter_css_id.$args['element_counter'].$args["form_prefix"]." li{float:left !important;width:auto !important;}";
				...
				$this->css_string=".".$containter_css_id.$args['element_counter'].$args["form_prefix"]." li{float:left !important;width:".$this->_percent."% !important;}";	
