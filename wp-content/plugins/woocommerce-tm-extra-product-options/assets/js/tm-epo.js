        ...
        function tm_epo_rules($thecart) {
            ...
            all_carts.each(function(cart_index,cart){
                ...
                if (!$cart.data('tm_rules_init_done')){
                    $cart.find('.tm-quantity .tm-qty').trigger('tmaddquantity');
        ...
        function tm_epo_init($form,$formcart) {
            ...
            .on('click.cpfv', function(e) {
                var t=$(this),
                    ...
                    $variation_form = t.closest( '.variations_form' ),
        ...
        function tm_product_image(){
            ...
            if ($(img).length>0){
                ...
                $(window).on('tm_attempt_product_image',function(e){
                    var tm_last_visible_image_element=$('.prettycheckbox:visible .tm-product-image:checked,.tm-product-image:checked:visible,select.tm-product-image').last();
                    var tm_last_visible_image_element_id=$(tm_last_visible_image_element).attr('name');
                ...
                $('.tm-product-image:checked,select.tm-product-image').last().trigger('tm_trigger_product_image');
            }
        }
