...
{
	height:' . ( $current_class->get_option( $location_name . '_first_level_item_height' ) / 2 ) . 'px;
	line-height:' . ( $current_class->get_option( $location_name . '_first_level_item_height' ) / 3 ) . 'px;
}
#mega_main_menu' . $location_class . '.icons-top > .menu_holder > .menu_inner > ul > li > .item_link.with_icon > .link_content > .link_text
{
	height:' . ( $current_class->get_option( $location_name . '_first_level_item_height' ) / 3 ) . 'px;
}
#mega_main_menu' . $location_class . '.icons-top > .menu_holder > .menu_inner > ul > li > .item_link > i
{
	padding-top:' . ( $current_class->get_option( $location_name . '_first_level_item_height' ) / 3 / 2 ) . 'px;
}
#mega_main_menu' . $location_class . '.icons-top > .menu_holder > .menu_inner > ul > li > .item_link > .link_content
{
	padding-bottom:' . ( $current_class->get_option( $location_name . '_first_level_item_height' ) / 3 / 2 ) . 'px;
}
#mega_main_menu' . $location_class . ' > .menu_holder > .menu_inner > ul > li.nav_buddypress > .item_link > i:before
{	
	width:' . ( $current_class->get_option( $location_name . '_first_level_item_height' ) * 0.6 ) . 'px;
}
...
{
	height:' . ( $current_class->get_option( $location_name . '_first_level_item_height_sticky' ) / 2 ) . 'px;
	line-height:' . ( $current_class->get_option( $location_name . '_first_level_item_height_sticky' ) / 3 ) . 'px;
}
...
{
	height:' . ( $current_class->get_option( $location_name . '_first_level_item_height_sticky' ) / 3 ) . 'px;
}
#mega_main_menu' . $location_class . '.icons-top > .menu_holder.sticky_container > .menu_inner > ul > li > .item_link > i
{
	padding-top:' . ( $current_class->get_option( $location_name . '_first_level_item_height_sticky' ) / 3 / 2 ) . 'px;
}
#mega_main_menu' . $location_class . '.icons-top > .menu_holder.sticky_container > .menu_inner > ul > li > .item_link > .link_content
{
	padding-bottom:' . ( $current_class->get_option( $location_name . '_first_level_item_height_sticky' ) / 3 / 2 ) . 'px;
}
#mega_main_menu' . $location_class . ' > .menu_holder.sticky_container > .menu_inner > ul > li.nav_buddypress > .item_link > i:before
{	
	width:' . ( $current_class->get_option( $location_name . '_first_level_item_height_sticky' ) * 0.6 ) . 'px;
}
#mega_main_menu' . $location_class . '.primary_style-buttons > .menu_holder.sticky_container > .menu_inner > ul > li > .item_link 
{
	margin:' . ( ( $current_class->get_option( $location_name . '_first_level_item_height_sticky' ) - $current_class->saved_options( $location_name . '_first_level_button_height' ) ) / 2 ) . 'px 4px;
}
...
@media (max-width: 767px) { /* DO NOT CHANGE THIS LINE (See = Specific Options -> Responsive Resolution) */
	...
	{
		margin:' . ( ( $current_class->get_option( $location_name . '_first_level_item_height_sticky' ) - $current_class->get_option( $location_name . '_first_level_button_height' ) ) / 2 ) . 'px 4px;
	}
}
/* style-buttons */
#mega_main_menu' . $location_class . '.primary_style-buttons > .menu_holder > .menu_inner > ul > li > .item_link, 
...
#mega_main_menu' . $location_class . '.primary_style-buttons > .menu_holder > .menu_inner > ul > li > .item_link 
{
	margin:' . ( ( $current_class->get_option( $location_name . '_first_level_item_height' ) - $current_class->get_option( $location_name . '_first_level_button_height' ) ) / 2 ) . 'px 4px;
}
...
{
	height:' . ( $current_class->get_option( $location_name . '_first_level_button_height' ) / 2 ) . 'px;
	line-height:' . ( $current_class->get_option( $location_name . '_first_level_button_height' ) / 3 ) . 'px;
}
...
{
	height:' . ( $current_class->get_option( $location_name . '_first_level_button_height' ) / 3 ) . 'px;
}
#mega_main_menu' . $location_class . '.primary_style-buttons.icons-top > .menu_holder > .menu_inner > ul > li > .item_link > i
{
	padding-top:' . ( $current_class->get_option( $location_name . '_first_level_button_height' ) / 3 / 2 ) . 'px;
}
#mega_main_menu' . $location_class . '.primary_style-buttons.icons-top > .menu_holder > .menu_inner > ul > li > .item_link > .link_content
{
	padding-bottom:' . ( $current_class->get_option( $location_name . '_first_level_button_height' ) / 3 / 2 ) . 'px;
}
/* color_scheme */
...
#mega_main_menu' . $location_class . ' li.multicolumn_dropdown > .mega_dropdown > .menu-item > .item_link > i
{
	...
	margin-top: -' . ( $current_class->get_option( $location_name . '_menu_dropdown_icon_font') / 2 ) . 'px;
}
...
{
	margin-left: ' . ( $current_class->get_option( $location_name . '_menu_dropdown_icon_font') + 8 ) . 'px;
}
...
{
	margin-right: ' . ( $current_class->get_option( $location_name . '_menu_dropdown_icon_font') + 8 ) . 'px;
}
...
{
	border-radius: ' . ( $current_class->get_option( $location_name . '_corners_rounding') / 2 ) . 'px;
}
';
