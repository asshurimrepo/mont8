...
<div class="subsubsub_section">
    ...
    <?php _e('<b style="color:red;">Note:</b> To update all currencies rates by one click - press radio button of the default currency and then press "Save changes" button!', 'woocommerce-currency-switcher'); ?><br />
