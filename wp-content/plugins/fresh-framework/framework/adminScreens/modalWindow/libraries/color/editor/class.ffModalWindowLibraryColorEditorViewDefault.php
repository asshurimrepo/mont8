						...
						<tr>
							...
							<td>
								<table>
									<tr>
										<td>
											<label for="ff-colorlib-color-hexcode"><span class="ff-modal-library-color-editor-label-left">#</span><input type="text" class="ff-colorlib-color-hexcode" id="ff-colorlib-color-hexcode"></label><br><br>
										</td>
										<td>
							...
							<td>
								<div style="border: 1px solid #e5e5e5; padding: 10px;">
									<h3 style="margin: 0 0 9px 0;">Preview</h3>
									<div style="width: 81px;height: 50px;background:#ff2a00;" class="ff-colorlib-color-preview-after"></div>
									<div style="width: 81px;height: 50px;background:#aa0000;" class="ff-colorlib-color-preview-before"></div>
								</div>
							</td>
						</tr>
					</table>
			...
			<div class="attachment-details save-ready">
				...
				<div class="ff-modal-library-item-details-settings-row">
					...
					<div class="ff-modal-library-item-details-settings-td">
						<input type="text" value="MyColor3">
					</div>
				</div>
				<div class="ff-modal-library-item-details-settings-row">
					<div class="ff-modal-library-item-details-settings-th">Tags</div>
					<div class="ff-modal-library-item-details-settings-td">
						<textarea>colors, user, hello world, bootstrap, red, blue, green</textarea>
					</div>
				</div>
			</div>
		</div>
