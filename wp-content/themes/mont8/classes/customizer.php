...
class Dokan_Customizer {
    ...
    function register_control( $wp_customize ) {
        ...
        // skin chooser
        $wp_customize->add_setting( 'color_skin', array( 'default' => 'pink.css' ) );
        ...
        // show featured
        /*$wp_customize->add_setting( 'show_featured', array( 'default' => 'off' ) );
        ...
        // show latest
        /*$wp_customize->add_setting( 'show_latest_pro', array( 'default' => 'off' ) );
        ...
        // show best selling
        /*$wp_customize->add_setting( 'show_best_selling', array( 'default' => 'off' ) );
