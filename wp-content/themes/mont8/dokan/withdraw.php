	...
	<div class="dokan-dashboard-content dokan-withdraw-content">
		...
		<article class="dokan-withdraw-area">
			...
			<div class="alert alert-info">
				<i class="fa fa-info"></i> Payments will be made on or before the <b>15<sup>th</sup></b> of <b>every
					month</b> for sales in the previous month via the chosen payment method.
			</div>
