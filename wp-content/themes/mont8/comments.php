...
<div id="comments" class="comments-area clearfix hide">
    ...
    <?php if ( have_comments() ) : ?>
        ...
        <ol class="commentlist">
             ...
             * to use tp_comment() to format the comments.
             * If you want to overload this in a child theme then you can
             * define tp_comment() and that will be used instead.
             * See tp_comment() in inc/template-tags.php for more.
             */
            wp_list_comments( array('callback' => 'dokan_comment') );
            ?>
        </ol><!-- .commentlist -->
